  ...
  return (
    <div className="flex flex-col gap-10 border-b border-[#8080802e] py-4 lg:py-8">
      ...
      <div className="flex flex-wrap items-center gap-10">
        ...
        <div className="flex flex-row items-center gap-5">
          <label title="monthly salary x 12 months">pension Contribution (Optional)</label>
          <input
        ...
        <div className="flex flex-row items-center gap-5">
          <label title="monthly salary x 12 months">NHF Contribution(Optional)</label>
          <input
        ...
        <div className="flex flex-row items-center gap-5">
          <label title="monthly salary x 12 months">Life Insurance (Premium) Optional</label>
          <input
            placeholder="--- ---"
            type="number"
            className="boder-none outline-none bg-[#80808018] p-2 lg:p-4 rounded-md"
